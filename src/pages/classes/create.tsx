...
const Create = () => {
  ...
  const setBannerImage = (file, feild) => {
    if (file) {
      feild.onChange(file.url)
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <UploadWidget value={field.value
                          ? { url: field.value, publicId: bannerPublicId ?? '' } : null}
                          onChange={(file: any, feild: any) => setBannerImage(file, feild)}
                        />
                      </FormControl>
                      <FormMessage />
