...
const Show = () => {
  ...
  // TODO: get teacher initials from name and display them in the UI 
  const teacherInitials =
    // first we do name split and filter out empty parts then we take the first 2 parts and do uppercase to the first letter of each part then we join them.
    teacherName
      .split(' ')
      .filter(Boolean)
      .slice(0, 2)
